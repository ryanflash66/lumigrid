    ...
    <main className="px-6 py-24">
      <section className="mx-auto grid max-w-6xl gap-10 lg:grid-cols-[1fr_1fr]">
        <div className="space-y-6">
          ...
          <h1 className="text-balance text-4xl font-semibold md:text-5xl">Tell us what you’re trying to achieve.</h1>
          <p className="text-lg text-muted-foreground">
            We respond within two business days with a scope outline, next available kickoff, and immediate actions you
            can take before the engagement starts.
          </p>
